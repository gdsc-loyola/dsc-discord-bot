            ...
            switch (args[0]){
                ...
                case 'help':
                    ...
                    .setColor("#31a5af")
                        .setTitle('GENERAL')
                        .addFields(
                            { name: '!announcements', value: 'sends the current announcements of DSCL' },
                    ...
                    message.author.send("Hi " + member + "! Here is the list of Andy the Atenean Android commands available!"); 
